...
int main(int argc, char** argv)
{
    ...
    dmp::util::open_cam(CAM_CAPTURE_W, CAM_CAPTURE_H, 20); // fps = 0 means as fast as possible
	...
	if (!pause) {
	  dmp::util::capture_cam(imgView, CAM_CAPTURE_W, CAM_CAPTURE_H, (CAM_CAPTURE_W-IMAGE_W)/2, (CAM_CAPTURE_H-IMAGE_H)/2, IMAGE_W, IMAGE_H);
	}
	...
	if (sync_cnn_out != 0)
	    print_result(TEXT_XOFS, TEXT_YOFS - 13, catrank(&networkOutput.front()), 0x88ff8800, 0x00ff0000, 0x00000001);

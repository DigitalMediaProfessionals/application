   ...
   while(exit_code == -1) {
    ...
    // HW processing times
        if (conv_time_tot != 0) {
            ...
            dmp::util::print_time_toDisplay( TEXT_XOFS, TEXT_YOFS + 4, "Total Processing Time           : ", conv_time_tot, 9999, 0xffff0000, 0x00000001);
        }
	...
	dmp::util::preproc_image(imgView, imgProc, IMAGE_W, IMAGE_H, -127.5, -127.5, -127.5, 0.0078431, true);

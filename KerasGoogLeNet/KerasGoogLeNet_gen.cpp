...
unsigned int CKerasGoogLeNet::get_total_layer_count()
{
    return num_layers;
}

unsigned int CKerasGoogLeNet::get_output_layer_count()
{
    return num_output_layers;
}

unsigned int CKerasGoogLeNet::get_convolution_layer_count()
{
    return num_conv_layers;
}

unsigned int CKerasGoogLeNet::get_innerproduct_layer_count()
{
    return num_fc_layers;
}

int CKerasGoogLeNet::initialize()
{
    num_layers = 18;
    num_output_layers = 1;
    num_conv_layers = 16;
...
void CKerasGoogLeNet::Layer_6()
{
    ...
    _conf.hw.run[2].actfunc = 2; // Activation Function: 0 = None, 1 = Tanh, 2 = Leaky ReLU
    ...
    _conf.hw.run[3].actfunc = 2; // Activation Function: 0 = None, 1 = Tanh, 2 = Leaky ReLU
    ...
    _conf.hw.run[4].actfunc = 2; // Activation Function: 0 = None, 1 = Tanh, 2 = Leaky ReLU
    ...
    _conf.hw.run[5].actfunc = 0; // Activation Function: 0 = None, 1 = Tanh, 2 = Leaky ReLU
    ...
    _conf.hw.run[6].actfunc = 2; // Activation Function: 0 = None, 1 = Tanh, 2 = Leaky ReLU
...
void CKerasGoogLeNet::Layer_16()
{
    ...
    cf.hw.actfunc = 0x0; // Activation Function: 0 = None, 1 = ReLU, 2 = Tanh, 3 = Leaky ReLU << 4

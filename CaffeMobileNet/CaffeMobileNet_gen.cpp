...
unsigned int CCaffeMobileNet::get_total_layer_count() {
  return num_layers;
}

unsigned int CCaffeMobileNet::get_output_layer_count() {
  return num_output_layers;
}

unsigned int CCaffeMobileNet::get_convolution_layer_count() {
  return num_conv_layers;
}

unsigned int CCaffeMobileNet::get_innerproduct_layer_count() {
  return num_fc_layers;
}

int CCaffeMobileNet::initialize() {
  num_layers = 30;
  num_output_layers = 1;
  num_conv_layers = 29;
  num_fc_layers = 0;
